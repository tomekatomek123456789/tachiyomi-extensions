...
class MangaSkanlacjeCMSSources : SourceFactory {
    /**
     ...
     */
    private fun parseSources(sourceString: List<String>): List<MangaSkanlacjeCMSSource> {
        // val parser = JsonParser()
        return sourceString.map {
            // Normalnie tutaj powinien być parser.parse() ale zamierzam zaaktualizować kod
            val jsonObject = parseString(it) as JsonObject
